...
SPI1_CHIP_FILES = ["/home/streeck/Desktop/2021_03_19_test/SPI1_ChIP_1_1.bg", 
    "/home/streeck/Desktop/2021_03_19_test/SPI1_ChIP_1_2bam.bg"]
...
act, kic, kid, reg, loss, learning_rate = ("relu_rect_both", 'he_uniform', 'he_uniform', "none", 'mean_squared_error', 0.01)
...
for dataset_key in training_dataset_dict:
    ...
    mask = tfb.combine_masks(*masks, 1)
    ...
    for i in range(each):          
        ...
        if (time.time() - script_start)/(60*60) > 18:
